...
of a user interface and is exposed by [github.com/uorg-saver/gio/app.FrameEvent]
received from windows.

The [Router] is used by [github.com/uorg-saver/gio/app.Window] to track window state and route
